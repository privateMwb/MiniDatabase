...
static void page_ids_monotonic() {
...
static void page_ids_unique_across_loads() {
...
static void table_ids_monotonic() {
    Database db("app");
...
static void table_ids_never_reused() {
    Database db("app");
...
static void run_tests() {
    RUN(page_ids_monotonic);
    RUN(page_ids_unique_across_loads);
    RUN(table_ids_monotonic);
    RUN(table_ids_never_reused);
}
