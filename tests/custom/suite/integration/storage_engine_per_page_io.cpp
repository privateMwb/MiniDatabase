...
static void multi_pages_round_trip() {
...
static void two_tables_no_clobber() {
...
static void cold_start_reads_prev() {
...
static void cachepage_evict_persists() {
...
static void unwritten_page_not_found() {
...
static void run_tests() {
    RUN(multi_pages_round_trip);
    RUN(two_tables_no_clobber);
    RUN(cold_start_reads_prev);
    RUN(cachepage_evict_persists);
    RUN(unwritten_page_not_found);
}
