...
static void bench_insert_1_page() {
    ...
    BENCH_SOLO_CUSTOM("insertRecord(1 page)", insert);
}
...
static void bench_insert_100_pages() {
    ...
    auto insert = [&] { (void)t.insertRecord(Record(nextId++)); };
    BENCH_SOLO_CUSTOM("insertRecord(100 pages)", insert);
}
...
static void bench_insert_1000_pages() {
    ...
    auto insert = [&] { (void)t.insertRecord(Record(nextId++)); };
    BENCH_SOLO_CUSTOM("insertRecord(1000 pages)", insert);
}
...
static void bench_get_at_scale() {
    ...
    BENCH_SOLO("getRecord(1 page)", getSmall);
    std::cout << "\n";
    ...
    BENCH_SOLO("getRecord(100 pages)", getMedium);
    std::cout << "\n";
    ...
    BENCH_SOLO("getRecord(1000 pages)", getLarge);
}
