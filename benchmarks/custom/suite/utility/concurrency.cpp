...
static void bench_save_all() {
    ...
    BENCH_SOLO_CUSTOM("saveAllTablesParallel", save);
...
static void bench_load_all() {
    ...
    BENCH_SOLO_CUSTOM("loadAllTablesParallel", load);
...
static void bench_rebuild_all() {
    ...
    BENCH_SOLO_CUSTOM("rebuildAllIndexesParallel", rebuild);
}
...
static void bench_export_all() {
    ...
    BENCH_SOLO_CUSTOM("exportAllTablesParallel", exportAll);
