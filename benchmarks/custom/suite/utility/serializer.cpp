...
static void bench_export_table() {
    ...
    BENCH_SOLO_CUSTOM("exportTableToFile", exportOnce);
...
static void bench_import_table() {
    ...
    BENCH_SOLO_CUSTOM("importTableFromFile", importOnce);
...
static void bench_export_database() {
    ...
    BENCH_SOLO_CUSTOM("exportDatabaseToJson", exportOnce);
...
static void bench_import_database() {
    ...
    BENCH_SOLO_CUSTOM("importDatabaseFromJson", importOnce);
