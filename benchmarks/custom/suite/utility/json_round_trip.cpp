...
static void bench_record_roundtrip() {
    ...
    BENCH_SOLO("Record to/fromJson", tree);
    std::cout << "\n";
    ...
    BENCH_SOLO("Record serial/deserial", str);
}
...
static void bench_page_roundtrip() {
    ...
    BENCH_SOLO_CUSTOM("Page to/fromJson", tree);
    std::cout << "\n";
    ...
    BENCH_SOLO_CUSTOM("Page serial/deserial", str);
}
...
static void bench_table_roundtrip() {
    ...
    BENCH_SOLO_CUSTOM("Table to/fromJson", tree);
    std::cout << "\n";
    ...
    BENCH_SOLO_CUSTOM("Table serial/deserial", str);
}
