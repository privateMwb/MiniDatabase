...
static void bench_insert_record() {
    ...
    BENCH_SOLO_CUSTOM("Table insertRecord", insert);
}
...
static void bench_update_record() {
    ...
    BENCH_SOLO("Table updateRecord", update);
}
...
static void bench_delete_record() {
    ...
    BENCH_SOLO("Table deleteRecord", del);
}
...
static void bench_rebuild_index() {
    ...
    BENCH_SOLO_CUSTOM("Table rebuildIndex", rebuild);
}
