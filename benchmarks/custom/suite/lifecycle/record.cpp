...
static void bench_default_ctor() {
    ...
    BENCH_SOLO("Record default ctor", ctor);
}
...
static void bench_id_ctor() {
    ...
    BENCH_SOLO("Record id ctor", ctor);
}
...
static void bench_data_ctor() {
    ...
    BENCH_SOLO("Record id+data ctor", ctor);
}
...
static void bench_copy() {
    ...
    BENCH_SOLO("Record copy ctor", copy);
}
...
static void bench_move() {
    ...
    BENCH_SOLO("Record move ctor", move);
}
