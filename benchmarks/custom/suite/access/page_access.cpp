...
static void bench_get_record_hit() {
    ...
    BENCH_SOLO("get record last slot", byId);
}
...
static void bench_get_at_hit() {
    ...
    BENCH_SOLO("get record at last slot", byIndex);
}
...
static void bench_get_record_miss() {
    ...
    BENCH_SOLO("get record id miss", missById);
}
...
static void bench_get_at_miss() {
    ...
    BENCH_SOLO("get record at oor", missByIndex);
}
