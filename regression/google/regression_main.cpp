...
void printUsage() {
    ...
    std::cerr << "\n"
              ...
              << "methods" << RESET << DARK_GRAY
              << " (e.g. \"a1\"), or just the letter (e.g. \"a\")\n"
              << "to run every benchmark in that group" << RESET << "\n";
}
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        // runs a suite by id. A bare letter with no trailing digit
        // (e.g. "a") is the "whole group" form of the same shortcut --
        // resolved to every benchmark name under that letter instead
        // of just one.
